...
<div class="container" ng-init="init()">
    ...
    <div class="col-md-2 pull-right " ng-show="loggedInEmail">
        <button class="btn btn-block btn-danger" type="submit" ng-click="logout()" ui-sref="login1">Logout
        </button>
    </div>
            ...
            <div class="panel panel-body todo-body">
                <form class="form-horizontal" name="todoForm" id="todoForm" >
                    ...
                    <div class="col-xs-offset-4 col-md-6" ng-hide="loggedInEmail">
                        <button class="btn btn-block btn-success" type="submit" ng-click="login()" ng-disabled="todoForm.$invalid">Login
                        </button>
                    </div>
